        ...
        <header className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex flex-wrap gap-2">
            <button
              type="button"
              onClick={() =>
                alert("Nanti diarahkan ke halaman manajemen user.")
              }
            ...
            <button
              type="button"
              onClick={() =>
                alert("Nanti diarahkan ke halaman konfigurasi SLA.")
              }
                ...
                {terminals.map((t) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      onClick={() =>
                        alert(
                          `Nanti buka modal edit untuk terminal ${
                            t.name ?? t.id
                          }`
                        )
                      }
            ...
            <div className="lg:col-span-1 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
              <div className="mb-3 flex items-center justify-between gap-2">
                ...
                <button
                  type="button"
                  onClick={() =>
                    alert("Aksi tambah lokasi belum di-implement.")
                  }
                  className="rounded-full bg-slate-900 px-3 py-1.5 text-[11px] font-semibold text-white hover:bg-slate-800"
                >
                  + Lokasi
