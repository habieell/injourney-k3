// src/features/tasks/pages/TaskAddPageView.tsx
"use client";
...
export function TaskAddPageView() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      ...
      if (error) {
        console.error("[TaskAddPageView] insert error", error);
        throw error;
      }
      ...
      console.error("[TaskAddPageView] failed create task", err);
...
export default TaskAddPageView;
